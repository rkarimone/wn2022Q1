...
SESSION_SECRET=11ffba52-11f8-11ef-b935-af91d546b0bd
WGUI_USERNAME=wgadmin
WGUI_PASSWORD=VeryStrongPassword
WGUI_MTU=1450
BIND_ADDRESS=8443
SUBNET_RANGES=100.72.64.0/22
WGUI_ENDPOINT_ADDRESS=PublicIPAddress
WGUI_PERSISTENT_KEEPALIVE=25
WGUI_SERVER_INTERFACE_ADDRESSES=100.72.64.1/22
WGUI_SERVER_LISTEN_PORT=51820
WGUI_DEFAULT_CLIENT_ALLOWED_IPS=100.72.64.0/22
